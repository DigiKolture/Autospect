                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" required value="@if(old('name')) {{old('name')}} @else {{$admin->name}} @endif" class="form-control" name="name" id="name" placeholder="Enter  username">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label for="email"> Email</label>
                                    <input type="email" required value="@if(old('email')) {{old('email')}} @else {{$admin->email}} @endif" class="form-control" name="email" id="email" placeholder="Enter  email ">
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone Number</label>
                                    <input type="number" required value="{{$admin->phone}}"  class="form-control" name="phone" id="phone" placeholder="Enter  number ">
                                </div>
