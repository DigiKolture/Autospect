                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" required class="form-control" name="phone" id="phone" placeholder="Enter  number ">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input name="photo_id" required type="file" class="custom-file-input" id="exampleInputFile">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" required class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password">
                            </div>
                            <div class="form-group">
